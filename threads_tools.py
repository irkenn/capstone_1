...
class ThreadTools():
    ...
    def add_thread(cls, request, spotify_id, user_id):
        ...
        if request.method == 'POST' and form.validate_on_submit():
            ...
            return render_template('threads/user-thread.html', item=json_spotify_item, item_type=f"{item_type}s", thread_item=thread_item)
    ...
    def show_thread(cls, request, spotify_id, user_id):
        ...
        if item_type == 'artist':
            # spotify_item = Artist.query.get(spotify_id)
